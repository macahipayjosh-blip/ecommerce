                    ...
                    <div className="w-full max-w-sm">
                        <div className="bg-white rounded-2xl shadow-lg border px-8 py-8"
                            ...
                            <div className="flex flex-col items-center mb-6">
                                ...
                                <p className="text-xs mt-1" style={{ color: '#6a8a6a' }}>Register as a Customer</p>
                            </div>
                            ...
                            <form onSubmit={submit} className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="text" required autoFocus value={data.first_name}
                                                ...
                                                placeholder="Juan" className={`${field(errors.first_name)} pl-8 pr-3 py-2.5`} />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="text" required value={data.last_name}
                                                ...
                                                placeholder="Dela Cruz" className={`${field(errors.last_name)} pl-8 pr-3 py-2.5`} />
                                        </div>
                                ...
                                {/* Middle name */}
                                <div>
                                    <Label>Middle Name <span className="normal-case font-normal text-gray-400">(optional)</span></Label>
                                    <div className="relative">
                                        <User className="absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5" style={{ color: '#6aaa4a' }} />
                                        <input type="text" value={data.middle_name}
                                            onChange={e => setData('middle_name', e.target.value)}
                                            placeholder="Santos" className={`${field()} pl-8 pr-3 py-2.5`} />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="email" required value={data.username}
                                            onChange={e => setData('username', e.target.value)}
                                            placeholder="email@example.com" className={`${field(errors.username)} pl-8 pr-3 py-2.5`} />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type={showPw ? 'text' : 'password'} required value={data.password}
                                            ...
                                            placeholder="Password" className={`${field(errors.password)} pl-8 pr-10 py-2.5`} />
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type={showConfirm ? 'text' : 'password'} required value={data.password_confirmation}
                                            ...
                                            placeholder="Confirm Password" className={`${field(errors.password_confirmation)} pl-8 pr-10 py-2.5`} />
